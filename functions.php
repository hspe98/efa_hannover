...
function getData($method, $outputFormat = "json", $query)
{
    ...
    // set url
    curl_setopt($ch, CURLOPT_URL, "https://app.efa.de/mdv_server/app_gvh/" . $method . "?session=0&outputEncoding=UTF-8&inputEncoding=UTF-8&outputFormat=" . $outputFormat . "&" . $query);
